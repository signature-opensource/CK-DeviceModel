...
namespace CK.DeviceModel.CppDeviceAdapter.Cpp
{
    ...
    public abstract class CppDevice<TConfiguration> : Device<TConfiguration> where TConfiguration : ICppDeviceConfiguration
    {
        ...
        protected CppDevice( IActivityMonitor monitor, TConfiguration config )
            : base( monitor, config )
        {
        ...
        protected override sealed Task<bool> DoStartAsync( IActivityMonitor monitor, bool fromConfiguration )
        {
            if( Callback == null )
            {
        ...
        protected override sealed Task DoStopAsync( IActivityMonitor monitor, StoppedReason reason )
        {
