...
namespace CK.DeviceModel.Tests
{
    ...
    public class DeviceHostDaemonStressTests
    {
        ...
        public async Task stress_test_Async( int nbDevice, int randomSeed, bool useDirectReconfiguration )
        {
            ...
            {
                r.Should().Match<DeviceApplyConfigurationResult>( r => r == DeviceApplyConfigurationResult.CreateAndStartSucceeded
            ...
            var devices = host.GetConfiguredDevices().Select( c => c.Device ).ToArray();
