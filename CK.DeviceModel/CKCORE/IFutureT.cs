...
namespace CK.Core
{
    ...
    /// the <see cref="Value"/>. This <c>AsTask()</c> doesn't return the Value itself and this is intentional.
    /// </para>
    /// </summary>
    ...
    {
        /// <summary>
        /// Gets whether <see cref="IFuture.IsCompleted"/> is true and a <see cref="Value"/> is available.
        /// </summary>
