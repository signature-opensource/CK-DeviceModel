...
namespace CK.Core
{
    public static class TaskExtensions
    {
        ...
        /// This is the fundamental feature of the <see cref="Future"/> and <see cref="Future{T}"/>.
        /// </summary>
        /// <param name="millisecondsTimeout">The timeout in milleseconds to wait before returning false.</param>
